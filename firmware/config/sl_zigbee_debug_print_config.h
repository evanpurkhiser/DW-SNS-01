...
#define SL_ZIGBEE_DEBUG_STACK_GROUP_ENABLED                                     (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_STACK_GROUP_RUNTIME_DEFAULT                             (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_CORE_GROUP_ENABLED                                      (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_CORE_GROUP_RUNTIME_DEFAULT                              (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_APP_GROUP_ENABLED                                       (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_APP_GROUP_RUNTIME_DEFAULT                               (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_ZCL_GROUP_ENABLED                                       (APP_DEBUG_BUILD)
...
#define SL_ZIGBEE_DEBUG_ZCL_GROUP_RUNTIME_DEFAULT                               (APP_DEBUG_BUILD)
